...
function [cortexL,targetL,targetC]=find_target_PC4(inv_file_name,MaskFile,TimePoints,plotCort,target_location)
...
for i_location =1:length(target_location)
    loc_ind_tmp=find(ROI_ind_group==target_location(i_location));

...
areanum=1;
yj_debug=1;
Base_dir='C:\Documents and Settings\Carolina\Desktop\inverse_results\';
...
%     top_cortex_ind=indzs;
    ...
    for i=1:n
        ...
        if min(dis2total_edge)<20 % if miminum distance to the cc points is less than 10, then count it; otherwise, delete it
...
%     ROI_ind = setdiff(ROI_ind,bad_ind);
    ...
    while (reply == 'Y' | reply=='y')
        clear ind
        s_maxclust = input('How many clusters there are? [4]: ','s');

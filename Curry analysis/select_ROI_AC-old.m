...
% deg_alpha = -21;
% exmaple:
% [ROI_ind,ROI_ind_group,Rx,allmasks]=select_ROI_AC_new('DW',-21,[],'control');
...
%     cdr_BL_file_name=[Base_dir,subjectName,'\new\',cdr_BL_file,'.cdr'];
    ...
    if strfind(subjectNames_allregion,subjectName)
        ...
        [edge7,Ecount,LNR,TM7]=read_Curry_file3_TM(edge7_file_name,'LOCATION',0,0);
...
%         hold on;
    ...
    while (reply == 'Y' | reply=='y')
        ...
        elseif reply2 == 'M' || reply2 == 'm'
            ...
            plot3(ROI_cluster(ROI_ind_group2==2,1),ROI_cluster(ROI_ind_group2==2,2),ROI_cluster(ROI_ind_group2==2,3),'.','Color','g','MarkerSize',marker_size+1);
            
            if ~isempty(ROI_cluster(ROI_ind_group2==3,1))
                plot3(ROI_cluster(ROI_ind_group2==3,1),ROI_cluster(ROI_ind_group2==3,2),ROI_cluster(ROI_ind_group2==3,3),'.','Color','m','MarkerSize',marker_size+1);
            end
            ...
            if ~isempty(ROI_cluster(ROI_ind_group2==6,1))
                plot3(ROI_cluster(ROI_ind_group2==6,1),ROI_cluster(ROI_ind_group2==6,2),ROI_cluster(ROI_ind_group2==6,3),'.','Color','c','MarkerSize',marker_size+1);
            end
            ...
            if ~isempty(ROI_cluster(ROI_ind_group2==8,1))
                plot3(ROI_cluster(ROI_ind_group2==8,1),ROI_cluster(ROI_ind_group2==8,2),ROI_cluster(ROI_ind_group2==8,3),'.','Color','m','MarkerSize',marker_size+1);
            end
            %axes(a1);

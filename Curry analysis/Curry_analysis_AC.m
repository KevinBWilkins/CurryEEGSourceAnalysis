...
function [Subject, cdr] = Curry_analysis_AC(varargin)
...
% subjects = subject;
% 
% %taskList={'abd_un_new,'ee_un_new3','hcl_un_new2'};
% taskList={'hcl_un_new2'};
% 
...
%taskList={'abd_new','ee_new3','hcl_new','abd_new2'};
taskList={'ee_new3'};
...
% subjects = subject;
% 
% %taskList={'abd_new3','ee_new','hcl_new','hcl_new2'};
% taskList={'hcl_new2'};
% 
% timePoints_total = [207];          %number of time points in each task
% timePoints_BL_total = [41];       %number of time points in each baseline
...
% timeRange_BL_total = {[-1953.1 -1796.7]};   %time ranges of baselines
% 
% im_cortex_name = 'AKpost1cortex.jpg';
% plotstop=129;   %where 0ms is       <-----------MUST CHANGE FOR EACH
%-------------------------------------------------------------------------
% subject = {'AKpost2'}
% subjects = subject;
% 
% %taskList={'abd_un_new2,'ee_un_new','hcl_un_new'};
% taskList={'hcl_un_new'};
% 
% timePoints_total = [207];          %number of time points in each task
% timePoints_BL_total = [41];       %number of time points in each baseline
...
% timeRange_BL_total = {[-1953.1 -1796.7]};   %time ranges of baselines
% 
% im_cortex_name = 'AKpost2cortex.jpg';
% plotstop=129;   %where 0ms is       <-----------MUST CHANGE FOR EACH
%-------------------------------------------------------------------------
% subject = {'LS1'}
% subjects = subject;
% 
% %taskList={'abd2','ef2','hcl2'};
% taskList={'hcl2'};
% 
% timePoints_total = [207];          %number of time points in each task
% timePoints_BL_total = [41];       %number of time points in each baseline
...
% plotstop=129;   %where 0ms is       <-----------MUST CHANGE FOR EACH SUBJECT
%-------------------------------------------------------------------------
% subject = {'LSpost1'}   %intact left arm of amputee LS post surgery
% subjects = subject;
% 
% %taskList={'abd_un_mri3','ef_un_mri2','hcl_un_mri','ho_un_mri'};
% taskList={'abd_un_mri3'};
% 
% timePoints_total = [207];          %number of time points in each task
% timePoints_BL_total = [41];       %number of time points in each baseline
% timeRange_total = {[-502.5 303.0]};     %time ranges of all tasks
% timeRange_BL_total = {[-1953.1 -1796.7]};   %time ranges of baselines
% 
% im_cortex_name = 'LSpost1cortex.jpg';
% plotstop=129;   %where 0ms is       <-----------MUST CHANGE FOR EACH SUBJECT
%-------------------------------------------------------------------------
% subject = {'LSpost2'}   %intact left arm of amputee LS post surgery
% subjects = subject;
% 
% %taskList={'abd_mri','ef_mri','hcl_mri','ho_mri'};
% taskList={'abd_mri'};
% 
% timePoints_total = [207];          %number of time points in each task
% timePoints_BL_total = [41];       %number of time points in each baseline
...
% timeRange_BL_total = {[-1953.1 -1796.7]};   %time ranges of baselines
% 
% im_cortex_name = 'LSpost2cortex.jpg';
% plotstop=129;   %where 0ms is       <-----------MUST CHANGE FOR EACH SUBJECT
%-------------------------------------------------------------------------
% subject = {'JS2'}
% subjects = subject;
...
%STROKE SUBJECTS
%-------------------------------------------------------------------------
% subject = {'FNrobot1'}  %after sampling correction
% subjects = subject;
% 
% %taskList={'RE_new_mri','0RE_new_mri'};
% taskList={'RE_new_mri'};
% 
% timePoints_total = [207];          %number of time points in each task
% timePoints_BL_total = [41];       %number of time points in each baseline
...
% plotstop=129;
% 
% im_cortex_name = 'FNrobot1cortex.jpg';
%-------------------------------------------------------------------------
% subject = {'FNrobot2'}    %after sampling correction
% subjects = subject;
% 
% %taskList={'25RE_new_mri'};
% taskList={'25RE_new_mri'};
% 
% timePoints_total = [207];          %number of time points in each task
% timePoints_BL_total = [41];       %number of time points in each baseline
...
%-------------------------------------------------------------------------
% subject = {'NTrobot1'}  %after sampling correction
% subjects = subject;
% 
% %taskList={'RE_new_mri','0RE_new_mri'};
% taskList={'0RE_new_mri'};
% 
% timePoints_total = [207];          %number of time points in each task
% timePoints_BL_total = [41];       %number of time points in each baseline
% timeRange_total = {[-502.5 303.0]};     %time ranges of all tasks
...
%-------------------------------------------------------------------------
% subject = {'NTrobot2'}  %after sampling correction
% subjects = subject;
% 
% %taskList={'25RE_new_mri'};
% taskList={'25RE_new_mri'};
...
% subjects = subject;
% 
% %taskList={'0RE_new_mri2','25RE_new_mri3'};
% taskList={'25RE_new_mri3'};
% 
% timePoints_total = [207];          %number of time points in each task
% timePoints_BL_total = [41];       %number of time points in each baseline
% timeRange_total = {[-502.5 303.0]};     %time ranges of all tasks
...
% subjects = subject;
% 
% %taskList={'RE_new_mri3','0RE_new_mri2'};
% taskList={'0RE_new_mri2'};
% 
% timePoints_total = [207];          %number of time points in each task
% timePoints_BL_total = [41];       %number of time points in each baseline
...
% subjects = subject;
% 
% %taskList={'RE_new_mri','0RE_new_mri','25RE_new_mri'};
% taskList={'25RE_new_mri'};
% 
% timePoints_total = [207];          %number of time points in each task
% timePoints_BL_total = [41];       %number of time points in each baseline
...
%-------------------------------------------------------------------------
% subject = {'BSrobot1'}  %after sampling correction
% subjects = subject;
% 
% %taskList={'RE_new_mri2','0RE_new_mri2','25RE_new_mri2'};
% taskList={'25RE_new_mri2'};
% 
% timePoints_total = [207];          %number of time points in each task
% timePoints_BL_total = [41];       %number of time points in each baseline
% timeRange_total = {[-502.5 303.0]};     %time ranges of all tasks
...
% subjects = subject;
% 
% %taskList={'RE_new_mri','0RE_new_mri2','25RE_new_mri'};
% taskList={'0RE_new_mri2'};
% 
% timePoints_total = [207];          %number of time points in each task
% timePoints_BL_total = [41];       %number of time points in each baseline
...
for k=1:subNo
    ...
    subjectNames_allregion = ['FNrobot1', 'FNrobot2', 'YZrobot1', 'YZrobot2', 'LS1', 'LS2','LSpost1','LSpost2','JS2','JS2new','JS3','JS4','GMrobot','CM103006','CM110206','CM1new2','CM2new2','AKpost1','AKpost2','AKpre1','AKpre2'];
...
%             line([1200 1200],[-10 max(log_e_y)],'Color','r','Linewidth',2);
            ...
            maxtargetC = max(max(targetC2(:,plotstart:plotstop)));
...
%             newtargetC2(find(newtargetC2<0))=0;
            ...
            realmaxtargetC = max(max(newtargetC2(:,plotstart:plotstop)));
...
%             newThreshold = newThreshold*maxtargetC;
...
%                 C_bin(Thr_ind) = 0;
            ...
            activesources = double(targetCI>newThreshold);
            oldactivesources = activesources;
            overthresholds{i,areanum} = sum(activesources,1);
            oldovertrhesholds{i,areanum} = overthresholds{i,areanum};
            
            %FIND SOURCES THAT APPEAR FOR MORE THAN 10MS- 3 samples in a row
            
            %find how many neighbors they have
            numneighbors = activesources + [zeros(size(activesources,1),1) activesources(:,1:(end-1))] + [activesources(:,2:(end)) zeros(size(activesources,1),1)];
            
            dum_a = numneighbors==3;
            dum_b = numneighbors==2;
            dum_c = dum_b + [zeros(size(activesources,1),1) dum_a(:,1:(end-1))] + [dum_a(:,2:(end)) zeros(size(activesources,1),1)];
            activesources = double((dum_c>1) + dum_a).*activesources;
            activesources = double(activesources>0);
            
            overthresholds{i,areanum} = sum(activesources,1);
            
            oldtargetCI = targetCI;
            targetCI = targetCI.*activesources;
            ...
            totalstrengths{i,areanum} = sum(targetCI.*double(activesources),1);
...
%             axis off;
            ...
            maxloc_cortex2_X = max(loc_cortex2(:,1));
            minloc_cortex2_X = min(loc_cortex2(:,1));
            maxloc_cortex2_Y = max(loc_cortex2(:,2));
            minloc_cortex2_Y = min(loc_cortex2(:,2));
            
            %normalized locations of boundary of ROI
            norm_new_perim(:,1) = (rot_new_perim(:,1)-(minloc_cortex2_X+maxloc_cortex2_X)/2)/((maxloc_cortex2_X-minloc_cortex2_X)/2);
            norm_new_perim(:,2) = (rot_new_perim(:,2)-(minloc_cortex2_Y+maxloc_cortex2_Y)/2)/((maxloc_cortex2_Y-minloc_cortex2_Y)/2);
            
            %normalized boundary locations of cortex
            norm_loc_cortex2(:,1) = (loc_cortex2(:,1)-(minloc_cortex2_X+maxloc_cortex2_X)/2)/((maxloc_cortex2_X-minloc_cortex2_X)/2);
            norm_loc_cortex2(:,2) = (loc_cortex2(:,2)-(minloc_cortex2_Y+maxloc_cortex2_Y)/2)/((maxloc_cortex2_Y-minloc_cortex2_Y)/2);
            
            %normalized locations of central sulcus
            norm_rot_censul(:,1) = (rot_censul(:,1)-(minloc_cortex2_X+maxloc_cortex2_X)/2)/((maxloc_cortex2_X-minloc_cortex2_X)/2);
            norm_rot_censul(:,2) = (rot_censul(:,2)-(minloc_cortex2_Y+maxloc_cortex2_Y)/2)/((maxloc_cortex2_Y-minloc_cortex2_Y)/2);
            
            %normalized locations of sources
            norm_newtargetL(:,1) = (newtargetL(:,1)-(minloc_cortex2_X+maxloc_cortex2_X)/2)/((maxloc_cortex2_X-minloc_cortex2_X)/2);
            norm_newtargetL(:,2) = (newtargetL(:,2)-(minloc_cortex2_Y+maxloc_cortex2_Y)/2)/((maxloc_cortex2_Y-minloc_cortex2_Y)/2); 
            
            %normalized locations of COG
            norm_mean_locs(1,:) = (mean_locs(1,:)-(minloc_cortex2_X+maxloc_cortex2_X)/2)/((maxloc_cortex2_X-minloc_cortex2_X)/2);
            norm_mean_locs(2,:) = (mean_locs(2,:)-(minloc_cortex2_Y+maxloc_cortex2_Y)/2)/((maxloc_cortex2_Y-minloc_cortex2_Y)/2);
            
            %make new CI matrix corresponding to normalized locations
            norm_newrot_XI = (newrot_XI-(minloc_cortex2_X+maxloc_cortex2_X)/2)./((maxloc_cortex2_X-minloc_cortex2_X)/2);;
            norm_newrot_YI = (newrot_YI-(minloc_cortex2_Y+maxloc_cortex2_Y)/2)./((maxloc_cortex2_Y-minloc_cortex2_Y)/2);;
            
            %new cortex image to fit normalized space
            imA_resize3 = imA_resize2(min(imG_pts_i):max(imG_pts_i),min(imG_pts_j):max(imG_pts_j),:); 
            
            
            %figure out centers of gravity using k-means clustering?
...
%             dummy_avg(isnan(dummy_avg)) = 0;
            ...
            if areanum==7
                ...
                for timenow = timestart+addtime1:timeinc:timestop+addtime2
                    ...
                    if isequal(cur_task,'RE_new_mri') | isequal(cur_task,'abd') | isequal(cur_task,'abd_un')
                        m_color = 'b';
                        imshow(imA_resize3,'XData',[-1 1],'YData',[1 -1])
                    elseif isequal(cur_task,'0RE_new_mri') 
                        m_color = 'g';
                        imshow(imA_resize3,'XData',[-1 1],'YData',[1 -1])
                    elseif isequal(cur_task,'25RE_new_mri')
                        m_color = 'm';
                        imshow(imA_resize3,'XData',[-1 1],'YData',[1 -1])
                    else
                        m_color = 'm';
                    ...
                    hold on;
                    plot3(norm_mean_loc(1),norm_mean_loc(2),newmaxrot_Z,'Markersize',20,'color',m_color,'LineStyle','.')
...
cdr.subjectName = subjectName;              %subject name
cdr.plotstart = plotstart;                  %plotstart
cdr.plotstop = plotstop;                    %plotstop
cdr.left_group = left_group;
cdr.newtargetL = newtargetL;                %unnormalized locations of sources
cdr.norm_newtargetL = norm_newtargetL;      %normalized locations of sources
cdr.oldactivesources = oldactivesources;
cdr.oldtargetCI = oldtargetCI;
cdr.activesources = activesources;
cdr.targetCI = targetCI;
cdr.newtargetC = newtargetC;                %normalized strengths of sources
cdr.maxtargetC = maxtargetC;                %mean of greatest 5% of strengths
cdr.newThreshold = newThreshold;            %normalized threshold
cdr.norm_mean_locs = norm_mean_locs;        %normalized locations of COG
cdr.norm_loc_cortex2 = norm_loc_cortex2;    %normalized locations of boundary of cortex
cdr.mincortX = mincortX;                    %minimum x coordinate
cdr.maxcortX = maxcortX;                    %maximum x coordinate
cdr.mincortY = mincortY;                    %minimum y coordinate
cdr.maxcortY = maxcortY;                    %maximum y coordinate
cdr.imA_resize2 = imA_resize2;              %unnormalized image of cortex
cdr.imA_resize3 = imA_resize3;              %normalized image of cortex
cdr.rot_new_perim = rot_new_perim;          %unnormalized locations of boundary of ROI
cdr.norm_new_perim = norm_new_perim;        %normalized locations of boundary of ROI
cdr.rot_censul = rot_censul;                %unnormalized locations of central sulcus
cdr.norm_rot_censul = norm_rot_censul;      %normalized locations of central sulcus
cdr.norm_newrot_XI = norm_newrot_XI;        %normalized x locations corresponding to newtargetC
cdr.norm_newrot_YI = norm_newrot_YI;        %normalized y locations corresponding to newtargetC
cdr.newrot_ZI = newrot_ZI;                  %unnormalized z locations corresponding to newtargetC
cdr.newmaxrot_Z = newmaxrot_Z;              %unnormalized locations of highest z coordinate
cdr.v_caxis = v_caxis;                      %color axis for cdr plot
cdr.new_mask_perim_filled_resize = new_mask_perim_filled_resize;    %matrix of which locations are to be displayed over ROI

savefilename = ['C:\Albert Chen\matlab\Curry analysis\cdr\',subjectName,'_',cur_task,'_','cdr.mat'];
eval(['save ''',savefilename,'''',' cdr Subject']); 

...
function [ROI_ind,ROI_ind_group,ROI_ind_group2,Rx,allmasks]=select_ROI_AC(varargin) 
...
%         censul_file_name1=[Base_dir,subjectName,'\Points\','CS_ac.pom'];   %central sulcus
        ...
        edge1_file_name=[Base_dir,subjectName,'\Points\','M1_R_kw.pom'];%M1_rt
        edge2_file_name=[Base_dir,subjectName,'\Points\','M1_L_kw.pom'];%M1_lt
        edge3_file_name=[Base_dir,subjectName,'\Points\','S1_R_kw.pom'];%S1_rt
        edge4_file_name=[Base_dir,subjectName,'\Points\','S1_L_kw.pom'];%S1_lt
        edge5_file_name=[Base_dir,subjectName,'\Points\','PM_R_kw.pom'];%PM_rt
        edge6_file_name=[Base_dir,subjectName,'\Points\','PM_L_kw.pom'];%PM_lt
        edge7_file_name=[Base_dir,subjectName,'\Points\','SMA_R_kw.pom'];%SMA_rt
        edge8_file_name=[Base_dir,subjectName,'\Points\','SMA_L_kw.pom'];%SMA_lt
        ...
        censul_file_name1=[Base_dir,subjectName,'\Points\','CS_kw.pom'];   %central sulcus
    end
